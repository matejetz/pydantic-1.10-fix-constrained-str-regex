...
def enum_schema(_schema_generator: GenerateSchema, enum_type: type[Enum]) -> core_schema.CoreSchema:
    ...
    if issubclass(enum_type, int):
        ...
        lax = core_schema.function_after_schema(literal_schema, to_enum)

    return core_schema.lax_or_strict_schema(
        lax_schema=lax,
        strict_schema=core_schema.is_instance_schema(enum_type),
        metadata=metadata,
    )
...
def uuid_schema(_schema_generator: GenerateSchema, uuid_type: type[UUID]) -> core_schema.LaxOrStrictSchema:
    ...
    return core_schema.lax_or_strict_schema(
        ...
        strict_schema=core_schema.is_instance_schema(uuid_type),
    )
...
def path_schema(_schema_generator: GenerateSchema, path_type: type[PurePath]) -> core_schema.LaxOrStrictSchema:
    ...
    return core_schema.lax_or_strict_schema(
        ...
        strict_schema=core_schema.is_instance_schema(path_type),
    )
...
def _deque_any_schema() -> core_schema.LaxOrStrictSchema:
    return core_schema.lax_or_strict_schema(
        ...
        strict_schema=core_schema.is_instance_schema(deque),
...
def _ordered_dict_any_schema() -> core_schema.LaxOrStrictSchema:
    return core_schema.lax_or_strict_schema(
        lax_schema=core_schema.function_wrap_schema(_validators.ordered_dict_any_validator, core_schema.dict_schema()),
        strict_schema=core_schema.is_instance_schema(OrderedDict),
    )
    ...
    if keys_arg == typing.Any and values_arg == typing.Any:
        ...
        return core_schema.lax_or_strict_schema(
            ...
            strict_schema=core_schema.chain_schema(
                core_schema.is_instance_schema(OrderedDict),
...
def ip_v4_address_schema(_schema_generator: GenerateSchema, _obj: Any) -> core_schema.LaxOrStrictSchema:
    metadata = build_metadata_dict(
...
def ip_v4_interface_schema(_schema_generator: GenerateSchema, _obj: Any) -> core_schema.LaxOrStrictSchema:
    metadata = build_metadata_dict(
...
def ip_v4_network_schema(_schema_generator: GenerateSchema, _obj: Any) -> core_schema.LaxOrStrictSchema:
    metadata = build_metadata_dict(
...
def ip_v6_address_schema(_schema_generator: GenerateSchema, _obj: Any) -> core_schema.LaxOrStrictSchema:
    metadata = build_metadata_dict(
...
def ip_v6_interface_schema(_schema_generator: GenerateSchema, _obj: Any) -> core_schema.LaxOrStrictSchema:
    metadata = build_metadata_dict(
...
def ip_v6_network_schema(_schema_generator: GenerateSchema, _obj: Any) -> core_schema.LaxOrStrictSchema:
    metadata = build_metadata_dict(
